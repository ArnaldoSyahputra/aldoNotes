...
import com.kunthu.arnaldo.aldoNotes.adapter.NoteAdapter;
...
import static com.kunthu.arnaldo.aldoNotes.NoteAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, LoadNotesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null)
            getSupportActionBar().setTitle("aldoNotes!");
